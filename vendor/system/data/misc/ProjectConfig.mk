...
#lenovo-sw mahj2 modify for 5M Begin
BOOT_LOGO = fhd
#lenovo-sw mahj2 modify for 5M End
BUILD_CTS = yes
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = yes
...
#lenovo.sw START wangsx3 config imgsensor
CUSTOM_HAL_FLASHLIGHT = dummy_flashlight
CUSTOM_HAL_IMGSENSOR = ov13850sunny_mipi_raw ov13850ofilma50_mipi_raw ov5670_mipi_raw ov5670lite_mipi_raw
CUSTOM_HAL_LENS = dw9761sunnyaf dw9761ofilma50af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =ov13850ofilma50_mipi_raw
CUSTOM_HAL_MAIN_BACKUP_LENS=dw9761ofilma50af
...
#lenovo.sw START wangsx3 config imgsensor
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =ov5670lite_mipi_raw
CUSTOM_HAL_SUB_BACKUP_LENS = 
CUSTOM_HAL_SUB_IMGSENSOR = ov5670_mipi_raw
CUSTOM_HAL_SUB_LENS = dummy_lens
#lenovo.sw END  wangsx3 config imgsensor
...
CUSTOM_KERNEL_IMGSENSOR = ov13850sunny_mipi_raw ov13850ofilma50_mipi_raw ov5670_mipi_raw ov5670lite_mipi_raw
#lenovo.sw END wangsx3 checkin camera imgsenosr driver for AIO
...
#lenovo.sw START wangsx3 checkin camera imgsenosr driver for AIO
CUSTOM_KERNEL_LENS = dw9761sunnyaf dw9761ofilma50af dummy_lens
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =ov13850ofilma50_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_LENS=dw9761ofilma50af
CUSTOM_KERNEL_MAIN_IMGSENSOR = ov13850sunny_mipi_raw
CUSTOM_KERNEL_MAIN_LENS = dw9761sunnyaf
#lenovo.sw END wangsx3 checkin camera imgsenosr driver for AIO
CUSTOM_KERNEL_RTC = rtc
#lenovo-sw zhouwl,2015-05-04,change for aio
#CUSTOM_KERNEL_SOUND = amp_6323pmic_spk
CUSTOM_KERNEL_SOUND =
CUSTOM_KERNEL_SSW = ssw_generic_v2
#lenovo.sw START 20141022 wangsx3 config imgsensor
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR =ov5670lite_mipi_raw
CUSTOM_KERNEL_SUB_BACKUP_LENS =
CUSTOM_KERNEL_SUB_IMGSENSOR = ov5670_mipi_raw
#lenovo.sw END 20141022 wangsx3 config imgsensor

CUSTOM_KERNEL_SUB_LENS = dummy_lens
CUSTOM_KERNEL_TOUCHPANEL = GT9XX_hotknot
CUSTOM_KERNEL_USB = mt6577
CUSTOM_KERNEL_VIBRATOR = vibrator
#Lenovo-sw linyf modify 2015-4-24 18:28 , change for AIO 5M project.
CUSTOM_MODEM = aio_5m_ltg aio_5m_lwg
...
#Lenovo-sw linyf modify 2015-6-3 18:28 , change for AIO 5M project.
MTK_APP_GUIDE = no
...
##lenovo-sw heww3 close audioprofile begin
...
#lenovo-sw mahj2 modify for ncp1854 Begin
MTK_BQ24261_SUPPORT = no
#lenovo-sw mahj2 modify for ncp1854 End
...
#lenovo sw kelw2 edit begin, rm MTK BLE MANAGER
#MTK_BT_BLE_MANAGER_SUPPORT = yes
MTK_BT_BLE_MANAGER_SUPPORT = no
#lenovo sw kelw2 edit end, rm MTK BLE MANAGER
...
MTK_BT_SUPPORT = yes
MTK_BUILD_VERNO = ALPS.L1.MP1.V1.9_LENOVO6752.65GC.L_P29
MTK_BWC_SUPPORT = yes
...
MTK_FIRST_MD = 1
#Lenovo-sw linyf modify 2014-11-19 15:28 , change for AIO 5M project.
MTK_FLIGHT_MODE_POWER_OFF_MD = no
MTK_FLV_PLAYBACK_SUPPORT = yes
#lenovo-sw fangzf1 modify 2015-06-04 close mtk fmradio app
MTK_FMRADIO_APP = no
...
#lenovo wuwl10 20150514 modify diable hdmi begin
MTK_HDMI_SUPPORT = no
#lenovo wuwl10 20150514 modify diable hdmi end
...
#begin ,lenovo-sw liyuan8 nonsupport hotknot
MTK_HOTKNOT_SUPPORT = no
#end ,lenovo-sw liyuan8 
...
MTK_MAV_SUPPORT = no
#Lenovo-sw linyf modify 2014-10-27 15:28 , change for AIO 5M project.
MTK_MD1_SUPPORT = 6
MTK_MD2_SUPPORT = 4
MTK_MD3_SUPPORT = 2
MTK_MD5_SUPPORT = 5
...
#Lenovo-sw linyf modify 2015-01-04 13:28 , change for AIO 5M project.
...
#begin, lenovo-sw zengzm 2015.05.14 remove app
MTK_MULTICORE_OBSERVER_APP = no
#end, lenovo-sw zengzm 2015.05.14 remove app
...
#Begin, lenovo-sw lumy1 remove nfc 
...
MTK_NFC_SE_NUM = 7
MTK_NFC_SUPPORT = no
#End, lenovo-sw lumy1 remove nfc 
...
#lenovo-sw jixj 2015.5.7 modified bgin for internal sdcard use fuse
#MTK_SHARED_SDCARD = no
MTK_SHARED_SDCARD = yes
#lenovo-sw jixj 2015.5.7 modified end
...
#Lenovo-sw linyf modify 2014-11-12 18:28 begin, change for AIO 5M project.
MTK_SIM_HOT_SWAP = no
...
MTK_VLW_APP = no
# Lenovo wuzb1 modify 2015-06-02 begin, removed voice unlock
...
# Lenovo wuzb1 modify 2015-06-02 end, removed voice unlock
...
LENOVO_PIEZO_SPEAKER_SUPPORT = yes
...
#Lenovo-sw wuzb1 add 2015-06-02 begin, use dlmalloc to reduce pss
MALLOC_IMPL = dlmalloc
#Lenovo-sw wuzb1 add 2015-06-02 end, use dlmalloc to reduce pss

#CREATE_PROJECT_INFO=20150414183631
###### Charging #########################
...
#Lenovo-sw zhuan1 add for sd card switch
LENOVO_SHARED_SDCARD = yes
#Lenovo-sw zhuan1 add for sd card swicth
