...
.method loadConfiguredNetworks()V
    ...
    .line 1513
    .local v16, "listStr":Ljava/lang/String;
    if-nez v16, :cond_1

    .line 1645
    .end local v16    # "listStr":Ljava/lang/String;
    :cond_0
    :goto_1
    return-void

    .line 1516
    .restart local v16    # "listStr":Ljava/lang/String;
    :cond_1
    const-string v21, "\n"
    ...
    .line 1521
    .local v17, "net":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .end local v12    # "i$":I
    .end local v14    # "len$":I
    .end local v17    # "net":Ljava/lang/String;
    :cond_2
    const/4 v11, 0x1
    ...
    const-string v22, " got CRC for SSID "
    ...
    .line 1566
    const-string v21, "Error: get a config with SSID null"
    ...
    const-string v22, "discarded duplicate network orig nid="
    ...
    iget-object v0, v5, Landroid/net/wifi/WifiConfiguration;->preSharedKey:Ljava/lang/String;
    ...
    const-string v22, "Mjkd86jEMGn79KhKll298Uu7-deleted"
    ...
    const-string v22, "catch deleted config "
...
.method public readNetworkVariablesFromSupplicantFile2(Ljava/lang/String;)Landroid/net/wifi/WifiShareInfo;
    ...
    .line 1780
    .local v0, "e":Ljava/io/IOException;
    const-string v10, "Could not reader.close()"
    ...
    .line 1780
    .restart local v0    # "e":Ljava/io/IOException;
    const-string v11, "Could not reader.close()"
