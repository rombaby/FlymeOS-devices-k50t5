...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/media/AudioService$CeramicSpeakerObserver;,
...
.field private static final CERAMIC_ALERT_WARNNING_KEY:Ljava/lang/String; = "ceramic_alert_warning"

.field private static final CERAMIC_SETTINGS_KEY:Ljava/lang/String; = "ceramics_state"

.field private static final CERAMIC_SPEAKER_OFF:Ljava/lang/String; = "GetPiezoShellSwitchStatus=7"

.field private static final CERAMIC_SPEAKER_ON:Ljava/lang/String; = "GetPiezoShellSwitchStatus=6"

.field private static final CERAMIC_SWITCH_SETTING:Ljava/lang/String; = "ceramics_state"
...
.field private mCeramicSpeakerObserver:Landroid/media/AudioService$CeramicSpeakerObserver;
...
.field private storedVolumeNotification:I

.field private storedVolumeRing:I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 168
    iput v6, p0, Landroid/media/AudioService;->storedVolumeRing:I

    .line 169
    iput v6, p0, Landroid/media/AudioService;->storedVolumeNotification:I
    ...
    .line 690
    new-instance v0, Landroid/media/AudioService$CeramicSpeakerObserver;

    invoke-direct {v0, p0}, Landroid/media/AudioService$CeramicSpeakerObserver;-><init>(Landroid/media/AudioService;)V

    iput-object v0, p0, Landroid/media/AudioService;->mCeramicSpeakerObserver:Landroid/media/AudioService$CeramicSpeakerObserver;
...
.method private checkForRingerModeChange(III)I
    ...
    const-string/jumbo v6, "switchModeWhenVolumeZero  "
    ...
    invoke-direct {p0, v4}, Landroid/media/AudioService;->isCts(Landroid/content/Context;)Z
    ...
    invoke-direct {p0, v2, v4, v7}, Landroid/media/AudioService;->setRingerMode(ILjava/lang/String;Z)V
...
.method private isCts(Landroid/content/Context;)Z
    .locals 11
    .param p1, "context"    # Landroid/content/Context;
    ...
    .line 3344
    .local v2, "composerTaskInfor":Landroid/app/ActivityManager$RunningTaskInfo;
    const/4 v3, 0x0
    ...
    const-string v8, "android.holo.cts"
...
.method private onSetStreamVolume(IIII)V
    ...
    invoke-direct {p0, v1, v2, v4}, Landroid/media/AudioService;->setRingerMode(ILjava/lang/String;Z)V
...
.method private onSetWiredDeviceConnectionState(IILjava/lang/String;)V
    ...
    const-string/jumbo v7, "onSetWiredDeviceConnectionState:device:"
    ...
    const-string v6, "before setStreamVolume Ring to index 8"
    ...
    iput v0, v1, Landroid/media/AudioService;->storedVolumeRing:I
    ...
    const-string v6, "before setStreamVolume Notificatoin to index 8"
    ...
    iput v0, v1, Landroid/media/AudioService;->storedVolumeNotification:I
    ...
    iget v5, v0, Landroid/media/AudioService;->storedVolumeRing:I
    ...
    const-string v7, "before restore Ring to"
    ...
    iget v7, v0, Landroid/media/AudioService;->storedVolumeRing:I
    ...
    iget v6, v0, Landroid/media/AudioService;->storedVolumeRing:I
    ...
    iput v5, v0, Landroid/media/AudioService;->storedVolumeRing:I

    .line 5126
    :cond_12
    move-object/from16 v0, p0

    iget v5, v0, Landroid/media/AudioService;->storedVolumeNotification:I
    ...
    const-string v7, "before restore Notificatoin to"
    ...
    iget v7, v0, Landroid/media/AudioService;->storedVolumeNotification:I
    ...
    iget v6, v0, Landroid/media/AudioService;->storedVolumeNotification:I
    ...
    iput v5, v0, Landroid/media/AudioService;->storedVolumeNotification:I
...
.method private setModeInt(ILandroid/os/IBinder;I)I
    ...
    .line 2309
    const-string v12, "is_ringtone=true"
    ...
    :cond_c
    const-string v12, "is_ringtone=false"
...
.method private setRingerMode(ILjava/lang/String;Z)V
    ...
    const-string/jumbo v6, "setRingerMode caller="
...
.method private setStreamVolume(IIILjava/lang/String;I)V
    ...
    const-string/jumbo v2, "setStreamVolume caller="
