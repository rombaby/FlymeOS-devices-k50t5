...
.method static synthetic access$1000(Landroid/app/ActivityThread;Landroid/os/IBinder;)V
    ...
    .prologue
    .line 181
    invoke-direct {p0, p1}, Landroid/app/ActivityThread;->handleCleanActivityStateLenovo(Landroid/os/IBinder;)V
...
.method private handleCleanActivityStateLenovo(Landroid/os/IBinder;)V
    .locals 8
    ...
    const-string v4, "handleCleanActivityStateLenovo "
    ...
    const-string v2, "handleCleanActivityStateLenovo: no activity for token "
    ...
    .line 3470
    :cond_0
    iget-boolean v0, v6, Landroid/app/ActivityThread$ActivityClientRecord;->paused:Z
    ...
    .line 3471
    invoke-direct/range {v0 .. v5}, Landroid/app/ActivityThread;->handlePauseActivity(Landroid/os/IBinder;ZZIZ)V

    .line 3473
    :cond_1
    iget-boolean v0, v6, Landroid/app/ActivityThread$ActivityClientRecord;->stopped:Z
    ...
    invoke-direct {p0, v6, v0, v7, v3}, Landroid/app/ActivityThread;->performStopActivityInner(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/app/ActivityThread$StopInfo;ZZ)V
    ...
    iget-object v2, v6, Landroid/app/ActivityThread$ActivityClientRecord;->window:Landroid/view/Window;
    ...
    .line 3481
    :cond_2
    invoke-direct {p0, v6, v7}, Landroid/app/ActivityThread;->updateVisibility(Landroid/app/ActivityThread$ActivityClientRecord;Z)V
    ...
    const-string v1, "handleCleanActivityStateLenovo finished"
    ...
    invoke-interface {v0, p1}, Landroid/app/IActivityManager;->cleanActivityStateFinishedLenovo(Landroid/os/IBinder;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static main([Ljava/lang/String;)V
    ...
    .line 5646
    sput-boolean v8, Landroid/app/ActivityThread;->mEnableAppLaunchLog:Z
    ...
    .line 5649
    sput-boolean v8, Landroid/app/ActivityThread;->mIsUserBuild:Z
    ...
    .line 5652
    sput-boolean v8, Landroid/app/ActivityThread;->mBooted:Z
    ...
    .line 5655
    sput-boolean v8, Landroid/app/ActivityThread;->mEnableLooperLog:Z
    ...
    const-string v8, "MAIN-ARGS launch log: "
    ...
    const-string v8, ", booted: "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    sget-boolean v8, Landroid/app/ActivityThread;->mBooted:Z

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v7

    const-string v8, ", looper log: "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    sget-boolean v8, Landroid/app/ActivityThread;->mEnableLooperLog:Z
    ...
    const-string v7, "ActivityThread is created"

    invoke-static {v6, v7}, Landroid/app/ActivityThread;->logAppLaunchTime(Ljava/lang/String;Ljava/lang/String;)V

    .line 5667
    sget-boolean v6, Landroid/app/ActivityThread;->IS_USER_BUILD:Z

    if-nez v6, :cond_5

    .line 5668
    const-string v6, "persist.sys.lenovoactivitylog"
    ...
    .line 5680
    .end local v0    # "activitylog":Ljava/lang/String;
    ...
    .line 5702
    new-instance v5, Landroid/app/ActivityThread;

    invoke-direct {v5}, Landroid/app/ActivityThread;-><init>()V

    .line 5703
    .local v5, "thread":Landroid/app/ActivityThread;
    invoke-direct {v5, v9}, Landroid/app/ActivityThread;->attach(Z)V
    ...
    :cond_6
    :try_start_1
    sget-object v6, Landroid/app/ActivityThread;->mSystemContext:Landroid/app/ContextImpl;
    ...
    .line 5721
    new-instance v6, Lcom/mediatek/anrappframeworks/ANRAppFrameworks;

    invoke-direct {v6}, Lcom/mediatek/anrappframeworks/ANRAppFrameworks;-><init>()V

    invoke-static {v6}, Lcom/mediatek/anrappmanager/ANRAppManager;->getDefault(Lcom/mediatek/anrappmanager/IFrameworks;)Lcom/mediatek/anrappmanager/ANRAppManager;

    move-result-object v4

    .line 5722
    .local v4, "mANRAppManager":Lcom/mediatek/anrappmanager/ANRAppManager;
    invoke-static {}, Landroid/os/Looper;->myLooper()Landroid/os/Looper;

    move-result-object v6

    sget-boolean v7, Landroid/app/ActivityThread;->mEnableLooperLog:Z

    invoke-virtual {v4, v7}, Lcom/mediatek/anrappmanager/ANRAppManager;->newMessageLogger(Z)Landroid/util/Printer;

    move-result-object v7

    invoke-virtual {v6, v7}, Landroid/os/Looper;->setMessageLogging(Landroid/util/Printer;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_1

    .line 5729
    .end local v4    # "mANRAppManager":Lcom/mediatek/anrappmanager/ANRAppManager;
    :cond_7
    :goto_1
    ...
    .end local v5    # "thread":Landroid/app/ActivityThread;
    .restart local v0    # "activitylog":Ljava/lang/String;
    :catch_0
    move-exception v2
    ...
    .restart local v5    # "thread":Landroid/app/ActivityThread;
    :catch_1
    move-exception v2
    ...
    const-string v8, "set ANR debugging mechanism state fair "
...
.method private performLaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/Intent;)Landroid/app/Activity;
    ...
    invoke-static {v3}, Landroid/content/res/VibeExtraConfiguration;->onActivityLaunch(Landroid/content/Context;)V
...
.method final handleConfigurationChanged(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
    ...
    invoke-static {v4, p1, v2}, Landroid/content/res/VibeExtraConfiguration;->handleConfigurationChanged(Landroid/app/Application;Landroid/content/res/Configuration;I)V
...
.method final performPauseActivity(Landroid/app/ActivityThread$ActivityClientRecord;ZZ)Landroid/os/Bundle;
    ...
    .line 3538
    .local v0, "alreadyPaused":Z
    iget-boolean v5, p1, Landroid/app/ActivityThread$ActivityClientRecord;->paused:Z
    ...
    iput-boolean v10, v5, Landroid/app/Activity;->mFinished:Z
    ...
    .line 3598
    :try_start_1
    iget-object v5, p0, Landroid/app/ActivityThread;->mOnPauseListeners:Landroid/util/ArrayMap;
    ...
    invoke-interface {v5, v7}, Landroid/app/OnActivityPausedListener;->onPaused(Landroid/app/Activity;)V
